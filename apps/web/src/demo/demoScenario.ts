...
export const DEMO_STEPS: DemoStep[] = [
  ...
  },
  {
    ...
    description: "Le formulaire reel de nouveau depot renseigne l'adresse, la parcelle AB 123, la zone UB et les contraintes patrimoniales.",
    route: "/citoyen/nouveau",
    highlightSelectors: ["#address", "[data-demo='location-analysis']"],
    waitMs: 1800,
    dossierStatus: "draft",
  },
  {
