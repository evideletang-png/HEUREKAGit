...
export function triggerSourceLabel(trigger: string) {
  const labels: Record<string, string> = {
    ...
    erp: "Projet > ERP",
    accessibilityDerogation: "Projet > Accessibilité",
    environmentalAuthorization: "Environnement > Autorisation environnementale",
    iotaDeclaration: "Environnement > Loi sur l'eau",
    protectedSpeciesDerogation: "Environnement > Espèces protégées",
    publicSafetyStudyRequired: "Projet > Sécurité publique",
    roadOrPublicSpaceModification: "Métropole > Voirie ou espace public",
    metropoleCompetence: "Métropole > Compétence métropolitaine",
  };
...
export const CERFA_DYNAMIC_QUESTIONS: RuleQuestion[] = [
  ...
  { trigger: "erp", label: "Le projet concerne-t-il un ERP nécessitant une consultation sécurité ?", dossierTypes: ["PC", "DPC", "DPA", "PA"] },
  { trigger: "accessibilityDerogation", label: "Le projet comporte-t-il une demande ou dérogation liée à l'accessibilité ?", dossierTypes: ["PC", "DPC", "DPA", "PA"] },
  { trigger: "publicSafetyStudyRequired", label: "Le projet nécessite-t-il une étude de sécurité publique ?", dossierTypes: ["PC", "PA"] },
  ...
  { trigger: "iotaDeclaration", label: "Votre projet relève-t-il d'une déclaration IOTA / loi sur l'eau ?", dossierTypes: ["PC", "DPC", "DPA", "PA"] },
  { trigger: "environmentalAuthorization", label: "Votre projet nécessite-t-il une autorisation environnementale ?", dossierTypes: ["PC", "DPC", "DPA", "PA"] },
  { trigger: "protectedSpeciesDerogation", label: "Votre projet nécessite-t-il une dérogation espèces protégées ?", dossierTypes: ["PC", "DPC", "DPA", "PA"] },
  ...
  { trigger: "roadOrPublicSpaceModification", label: "Le projet modifie-t-il la voirie ou l'espace public ?", dossierTypes: ["PC", "DPC", "DPA", "PA"] },
  { trigger: "metropoleCompetence", label: "Le projet relève-t-il d'une compétence métropolitaine à consulter ?", dossierTypes: ["PC", "DPC", "DPA", "PA"] },
