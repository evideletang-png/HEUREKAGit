...
// Make sure to configure the QueryClient to retry failures less aggressively
...
function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <TooltipProvider>
        {/* Replace base URL setup specifically for proper routing in Replit/nested environments */}
